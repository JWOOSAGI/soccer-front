...
function Home() {
  ...
  const question = [
    ...
    ["16", "홈팀이 3점이상 차이로 승리한 경기의 경기장 이름 경기 일정 홈팀 이름과 원정팀 이름 구하기"],
    ["17", "STADIUM 에 등록된 운동장 중에서 홈팀이 없는 경기장까지 전부 나오도록"],
    ["18", "페이지네이션 로직을 위한 플레이어 테이블에서 최상단 5개 로우를 출력"],
    ["19", "평균키가 인천 유나이티스팀('K04')의 평균키  보다 작은 팀의 팀ID, 팀명, 평균키 추출"],
    ["20", "포지션이 MF 인 선수들의 소속팀명 및 선수명, 백넘버 출력"],
    ["21", "가장 키큰 선수 5명 소속팀명 및  선수명, 백넘버 출력"],
